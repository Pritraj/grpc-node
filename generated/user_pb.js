...
goog.exportSymbol('proto.user.User.Role', null, global);
/**
...
proto.user.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = /** @type {!proto.user.User.Role} */ (reader.readEnum());
      msg.setRole(value);
      break;
    case 6:
 ...
 * @return {!proto.user.User.Role}
 */
proto.user.User.prototype.getRole = function() {
  return /** @type {!proto.user.User.Role} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/**
 * @param {!proto.user.User.Role} value
 * @return {!proto.user.User} returns this
 */
 ...
 * @return {number}
 */
proto.user.ListUsersResponse.prototype.getTotalCount = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.user.ListUsersResponse} returns this
 */
proto.user.ListUsersResponse.prototype.setTotalCount = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.user.ListUsersResponse.prototype.getSuccess = function() {
 ...
 * @return {!proto.user.ListUsersResponse} returns this
 */
proto.user.ListUsersResponse.prototype.setSuccess = function(value) {
...
/**
 * optional User.Role role = 4;
 * @return {!proto.user.User.Role}
 */
proto.user.CreateUserRequest.prototype.getRole = function() {
  return /** @type {!proto.user.User.Role} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {string}
 */
proto.user.CreateUserResponse.prototype.getError = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.user.CreateUserResponse} returns this
 */
proto.user.CreateUserResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.user.UpdateUserResponse.prototype.getError = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.user.UpdateUserResponse} returns this
 */
proto.user.UpdateUserResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.user.DeleteUserResponse.prototype.getError = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.user.DeleteUserResponse} returns this
 */
proto.user.DeleteUserResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
